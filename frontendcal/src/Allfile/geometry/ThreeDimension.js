    ...
    return (
        <div className="threeD">
            <nav className="geometry-nav">
                <p style={{margin:'0 0 0 450px'}}>3-Dimension Calculate</p>
                <button className='nav-button' style={{margin:'0 0 0 350px'}} onClick={unitConversion}>Go To Unit Conversion</button>
            </nav>
            <div>
                <Form className={`threeD-form ${showResults ? 'expanded' : ''}`} onSubmit={handleSubmit}>
                <div style={{display:'flex',gap:'10px'}}>
                    ...
                    <FormField>
                        <label>Z<sub>1</sub></label>
                        <input placeholder='z1' type="number"
                        value={z1}
                    ...
                    <FormField>
                        <label>Z<sub>2</sub></label>
                        <input placeholder='z2' type="number" 
                        value={z2}
                        onChange={(e) => setZ2(e.target.value)}
                        />
                    </FormField>
                    </div>
                    <Button type='submit' style={{ marginLeft: '100px' }}>3D-Calculate</Button>
                    {showResults && (
                        <div className="threeD-result">
